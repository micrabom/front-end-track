...
export const AddTask = () => {
    ...
    const [lastSprintUpdate, setLastSprintUpdate] = useState(() => {
        const lastSPUpdate = localStorage.getItem('lastSprintUpdate');
        return lastSPUpdate ? new Date(lastSPUpdate) : null;
    });
    const [lastBacklogUpdate, setLastBacklogUpdate] = useState(() => {
        const lastBLUpdate = localStorage.getItem('lastBacklogUpdate');
        return lastBLUpdate ? new Date(lastBLUpdate) : null;
    });
